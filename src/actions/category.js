    ...
    return async (dispatch) => {
        try {
            ...
            if (body.ok) {
                ...
                dispatch(categoriesAddCategory(body.data.product_categories));
...
export const categoriesStartUpdateCategory = (id, data) => {
    return async (dispatch) => {
        try {
            ...
            if (body.ok) {
                console.log(body)
                dispatch(categoriesUpdateCategory(body.data.product_categories));
            } else {
                console.log(body)
                Swal.fire({
                    title: '¡Oops!',
...
export const gradesStartDeleteGrade = (id) => {
    return async (dispatch) => {
        try {
            dispatch(uiStartLoading())
            ...
            if (body.ok) {
                console.log(body)
                dispatch(categoriesDeleteCategory(body.data.product_categories));
            } else {
                console.log(body)
                Swal.fire({
                    title: '¡Oops!',
...
const categoriesCleanActiveCategory = () => ({
